...
function render_login_canvas(){
  ...
  var font_size = 193;
  ctx.font = "bold "+font_size+"pt Helvetica";
  ctx.fillStyle = "#9ff";
  ctx.fillText("LOGIN",(b_width*0.055),(b_height/3.5));
  ctx.beginPath();
  ctx.moveTo((b_width*0.052)+25,(b_height/3.5)+50);
  ctx.lineTo((b_width*0.052)+806,(b_height/3.5)+50);
  ctx.lineWidth=1;
  ctx.stroke();
